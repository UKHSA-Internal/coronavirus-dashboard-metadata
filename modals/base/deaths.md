All people who died after having a positive test are included, irrespective of the duration between their positive test and date of death. The actual cause of death may not be COVID-19 in all cases.  People who died from COVID-19 but had not been tested or had not tested positive are not included.
...
Data for Northern Ireland include all cases reported to the Public Health Agency (PHA) where the deceased had a positive test for COVID-19.  PHA sources include reports by healthcare workers (eg Health and Social Care Trusts, GPs) and information from local laboratory reports. Deaths reported against each date cover the 24 hours up to 9:30am on the same day.
